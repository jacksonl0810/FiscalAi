...
const PopoverContent = React.forwardRef(/** @param {React.ComponentPropsWithoutRef<typeof PopoverPrimitive.Content>} props */ ({ className, align = "center", sideOffset = 4, ...props }, ref) => (
